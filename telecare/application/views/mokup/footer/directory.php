...
<div class="row" style="margin: 50px 10%;text-align: center">
    <span class="mokup-border">Our Team</span>
</div>
<div class="row" style="margin: 50px 10%;padding: 0 10%">
    <img class="mokup-no-imag" src="<?=base_url()?>assets/mokup/noimage.png" style="width: 40%;height: 200px;">
    <img class="mokup-no-imag" src="<?=base_url()?>assets/mokup/noimage.png" style="width: 40%;height: 200px;margin-left: 10%">
    <br><br>
    <img class="mokup-no-imag" src="<?=base_url()?>assets/mokup/noimage.png" style="width: 40%;height: 200px;">
    <img class="mokup-no-imag" src="<?=base_url()?>assets/mokup/noimage.png" style="width: 40%;height: 200px;margin-left: 10%">
</div>
...
<div class="row" style="margin: 50px 10%;text-align: center">
    <span class="mokup-border">Advisory Board Members</span>
</div>
